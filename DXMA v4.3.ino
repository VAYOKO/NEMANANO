//This code for Nemanano OS developer by Varis Vipavanich IPRDEV.com copyright
//font on board u8g2_font_unifont_t_symbols u8g2_font_helvR08_tr u8g2_font_unifont_t_chinese2
...
boolean f1 = false;
boolean f2 = false;
boolean time1_cmd = false;
boolean unlockpage = false;
unsigned long lastButtonPress = 0;
#define buz 2
//MENU LABLE at      ^0        ^1             ^2          ^3        ^4         ^5         ^6          ^7
...
void unlock_page() {
  ...
  u8g2.drawStr(20, 30, "Prese any Key");

  u8g2.sendBuffer();
  if ((analogRead(A0) >= 900) || (digitalRead(SW) == LOW)) {
    unlockpage = true;
  }
}
...
void check_home1() {
  ...
  if ((digitalRead(SW) == LOW) && (counter_menu == 1)) {  //Setting menu
    delay(100);
  ...
  if ((digitalRead(SW) == LOW) && (counter_menu == 2)) {  //MANULE MENU
    delay(100);
  ...
  if ((digitalRead(SW) == LOW) && (counter_menu == 3)) {  //AUTONOMOUS
    delay(100);
  ...
  if ((digitalRead(SW) == LOW) && (counter_menu == 4)) {  //ALARM
    delay(100);
  ...
  if ((digitalRead(SW) == LOW) && (counter_menu == 5)) {  //PAYLOAD
    delay(100);
  ...
  if ((digitalRead(SW) == LOW) && (counter_menu == 6)) {  //SYSTEM
    delay(100);
  ...
  if ((digitalRead(SW) == LOW) && (counter_menu == 7)) {  //INTERFACE
    delay(100);
    if ((digitalRead(SW) == HIGH) && (counter_menu == 7)) {
      f1 = true;
      while (f1 == true) {
        u8g2.sendBuffer();
        if (analogRead(A0) >= 1015) {
          u8g2.clearBuffer();
          u8g2.setFont(u8g2_font_helvR08_tr);
          u8g2.drawButtonUTF8(55, 25, U8G2_BTN_INV, 0, 8, 4, "B1");

          u8g2.drawButtonUTF8(105, 25, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B2");

          u8g2.drawButtonUTF8(105, 55, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B4");
          u8g2.drawButtonUTF8(60, 55, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B3");
          u8g2.drawCircle(20, 40, 10, U8G2_DRAW_ALL);

          u8g2.drawStr(0, 13, arr[7]);  // a, r - średnica, p - długość
          u8g2.sendBuffer();
        } else if ((analogRead(A0) >= 1005) && (analogRead(A0) <= 1016)) {

          u8g2.clearBuffer();
          u8g2.setFont(u8g2_font_helvR08_tr);
          u8g2.drawButtonUTF8(100, 25, U8G2_BTN_INV, 0, 8, 4, "B2");

          u8g2.drawButtonUTF8(60, 25, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B1");
          u8g2.drawButtonUTF8(105, 55, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B4");
          u8g2.drawButtonUTF8(60, 55, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B3");
          u8g2.drawCircle(20, 40, 10, U8G2_DRAW_ALL);
          ...
          u8g2.drawStr(0, 13, arr[7]);  // a, r - średnica, p - długość
          u8g2.sendBuffer();
        } else if ((analogRead(A0) >= 1000) && (analogRead(A0) <= 1007)) {

          u8g2.clearBuffer();
          u8g2.setFont(u8g2_font_helvR08_tr);
          u8g2.drawButtonUTF8(55, 55, U8G2_BTN_INV, 0, 8, 4, "B3");
          u8g2.drawButtonUTF8(105, 25, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B2");
          u8g2.drawButtonUTF8(60, 25, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B1");
          u8g2.drawButtonUTF8(105, 55, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B4");
          ...
          u8g2.drawStr(0, 13, arr[7]);  // a, r - średnica, p - długość
          u8g2.sendBuffer();
        } else if ((analogRead(A0) >= 900) && (analogRead(A0) <= 950)) {

          u8g2.clearBuffer();
          u8g2.setFont(u8g2_font_helvR08_tr);
          u8g2.drawButtonUTF8(100, 55, U8G2_BTN_INV, 0, 8, 4, "B4");
          u8g2.drawButtonUTF8(105, 25, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B2");
          u8g2.drawButtonUTF8(60, 25, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B1");
          u8g2.drawButtonUTF8(60, 55, U8G2_BTN_SHADOW1 | U8G2_BTN_HCENTER | U8G2_BTN_BW2, 20, 2, 2, "B3");
